...
@section('content')
    <div class="col-sm-10 center-block">
        <form class="form-horizontal" method="post" action="{{route('a_Update_page')}}" >
            {{ csrf_field() }}
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 pull-left">
                        <button type="submit" class="btn btn-success btn-block" name="page_id" value="{{$f_page->id}}" >Submit</button>
                    </div>
                </div>
            </div>
        </form>
