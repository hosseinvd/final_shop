        ...
        <div class="breadcrumb-area">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="active"> سفارشات تائید نشده</li>
                </ol>
            </div>
        </div>
                                        ...
                                        <td style="width:20%">
                                            <a data-toggle="collapse" data-parent="#accordion"
                                               href="#collapse{{$i}}">جزئیات سفارش <i
                                                        class="fa fa-arrow-circle-down fa-2x" aria-hidden="true"></i>
                                            </a>
                                            ...
                                            <div class="row  ">
                                                ...
                                                <div class="col-md-7 col-sm-5 col-xs-12">
                                                    <div class="coupon">
                                                        ...
                                                        <p>
                                                            <button type="button" class="btn btn-success approve_basket"
                                                                    id="{{$basket->id}}"><i class="fa fa-thumbs-up"></i>تائید
                                                            </button>
                                                            <button type="button"
                                ...
                                <tbody>
                                    @foreach($basket->payments as $index=>$payment)
                                        ...
                                        @endif
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-success btn-xs  btn-payment-approve"

                                                        id="{{$payment->id}}"
                                                >تائید<i class="fa fa-thumbs-up fa-x"></i>
                                                </button>
                                                <button type="button" class="btn btn-danger btn-xs btn-payment-disapprove"
                                                ...
                                                <a href="{{route('a_show_edit_payment',$payment->id)}}"  class="btn btn-warning btn-xs btn-payment-edit"
                                                   ><i class="fa fa-edit">ویرایش</i>
                                                </a>
                                                <a href="{{route('a_show_payment',$payment->id)}}"  class="btn btn-info btn-xs btn-payment-show"
